<aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
  <div class="h-19.5">
    ...
    <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="javascript:;" target="_blank">
      ...
      <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Bluskyz Sistem</span>
    </a>
  </div>
  ...
  <div class="items-center block w-auto max-h-screen overflow-auto h-full grow basis-full">
    <ul class="flex flex-col pl-0 mb-0">
      ...
      <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 ml-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/admin/customer">   
          
          <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            <i class="fas fa-users   
       fa-sm" style="color: rgb(72, 76, 81)"></i>
          </div>
          <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft text-dark">Customer</span>
        </a>
      </li>
      ...
      <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="../pages/billing.html">
          ...
          <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Promo</span>
        </a>
      </li>
      ...
      <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="../pages/profile.html">
          ...
          <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Testimonial</span>
        </a>
      </li>
